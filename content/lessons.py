...
2020-е: Трансформеры и большие языковые модели""",
        "check_question": "Какой тип машинного обучения использует размеченные данные?",
        "check_options": ["A) Обучение с учителем", "B) Обучение без учителя", "C) Обучение с подкреплением"],
        "check_correct": "A",
        "materials": [
            "📖 Курс ML на Coursera: https://www.coursera.org/learn/machine-learning",
            "📚 Книга «Введение в машинное обучение» Андрея Карпатого",
